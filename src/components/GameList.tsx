...
const GameList = () => {
  ...
  const games = [
    ...
    { id: 3, name: "Free Fire", image: "/list-ml.png", description: "Joki rank Free Fire." },
    { id: 4, name: "Dota 2", image: "/list-ml.png", description: "Joki MMR Dota 2." },
    { id: 5, name: "Valorant", image: "/list-ml.png", description: "Joki rank Valorant." },
    { id: 6, name: "Apex Legends", image: "/list-ml.png", description: "Joki rank Apex Legends." },
    { id: 7, name: "League of Legends", image: "/list-ml.png", description: "Joki rank LoL." },
